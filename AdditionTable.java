...
/**
 * This Class can make an Addition Table
 */
public class AdditionTable {

    /**
    * tableGen creates an addition table with one user inputed list.
    */
    ...
    */
    ...
    /**
    * tableGen2 creates an addition table with two user inputed lists.
    */
